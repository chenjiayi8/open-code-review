export const en = {
  ...
  'features.feat3Desc': 'Runs reviews through authenticated local Codex or Claude subscription CLIs. OCR keeps file selection, rule routing, concurrency, and comment placement deterministic while the runner owns authentication.',
