export const en = {
  ...
  'features.feat3Title': 'Subscription Runner Support',
  'features.feat3Desc': 'Runs reviews through authenticated local Codex or Claude subscription CLIs. OCR keeps file selection, rule routing, process timeout, and comment placement deterministic while the runner owns authentication.',
  ...
  'quickstart.subtitle': 'No provider setup or OCR API keys. Use your local Codex or Claude subscription login.',
  ...
  'docs.configDesc': 'Authenticate an installed local subscription runner. OCR does not store provider endpoints, models, or API keys.',
  ...
  'docs.configModelSelectDesc': 'Use claude auth login --claudeai to authenticate the Claude runner before running OCR.',
  ...
  'docs.configManualBuiltinDesc': 'Use --runner to choose the authenticated local subscription CLI for this invocation.',
