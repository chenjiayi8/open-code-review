...
export const zh: TranslationKeys = {
  ...
  'quickstart.subtitle': '无需供应商配置或 OCR API 密钥，使用本地 Codex 或 Claude 订阅登录即可。',
  ...
  'docs.configDesc': '登录已安装的本地订阅 runner。OCR 不保存供应商端点、模型或 API 密钥。',
  ...
  'docs.configModelSelectDesc': '运行 claude auth login --claudeai，在使用 OCR 前认证 Claude runner。',
  ...
  'docs.configManualBuiltinDesc': '使用 --runner 为本次调用选择已认证的本地订阅 CLI。',
