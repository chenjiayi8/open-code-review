...
export const zh: TranslationKeys = {
  ...
  'features.feat3Title': '订阅 Runner 支持',
  'features.feat3Desc': '通过已登录的本地 Codex 或 Claude 订阅 CLI 运行评审。OCR 负责文件选择、规则路由、并发和评论定位，认证由 runner 管理。',
  ...
  'quickstart.subtitle': '无需配置 OCR 凭据。使用已安装的 Codex 或 Claude CLI 的现有原生登录或受支持的 API token。',
  'quickstart.step1Title': '安装',
  'quickstart.step1Desc': '通过 npm 一行命令全局安装。',
  'quickstart.step1Label1': '安装',
  'quickstart.step1Label2': '验证安装',
  'quickstart.step2Title': '登录 Runner',
  'quickstart.step2Desc': '登录 Codex 或 Claude，然后在每条 OCR 命令中选择 runner。',
  'quickstart.step2Label1': 'Codex 登录',
  'quickstart.step2Label2': 'Claude 登录',
  'quickstart.step2Label3': '使用 Runner 运行',
  ...
  'docs.configTitle': 'Runner 认证',
  'docs.configDesc': '通过原生登录或受支持的 API token 认证已安装的本地 runner。OCR 不保存供应商端点、模型或凭据。',
  'docs.configInteractive': 'Codex 登录',
  'docs.configInteractiveDesc': '运行 codex login，在使用 OCR 前认证 Codex runner。',
  'docs.configModelSelect': 'Claude 登录',
  'docs.configModelSelectDesc': '使用 Claude CLI 的原生登录或受支持的 API token，然后再通过 Claude runner 运行 OCR。',
  'docs.configListProviders': '必需 Runner 参数',
  'docs.configListProvidersDesc': '每次非 preview 的 review 或 scan 都传入 --runner codex 或 --runner claude。',
  'docs.configManual': '单次运行选项',
  'docs.configManualBuiltin': '选择 Runner',
  'docs.configManualBuiltinDesc': '使用 --runner 为本次调用选择已认证的已安装本地 CLI。',
  'docs.configManualCustom': '可选 Runner 模型',
  'docs.configManualCustomDesc': '连接到私有化部署或其他兼容端点。',
  'docs.configManualCustomNote': '--preview 等只读/预检命令不会调用 runner。',
  'docs.configKeys': '支持的配置键',
  'docs.configKeyProvider': 'Runner 名称：codex 或 claude',
  'docs.configKeyProviderApiKey': '认证保存在 runner CLI 中',
  'docs.configKeyProviderModel': '单次运行的可选 runner 模型',
  'docs.configKeyProviderUrl': 'OCR 不覆盖端点',
  'docs.configKeyProviderExtraBody': 'OCR 无凭据请求体字段',
  'docs.configKeyProviderExtraHeaders': 'OCR 无凭据请求头',
  ...
  'docs.reviewFlag7Desc': '本地 runner 进程整体超时时间（分钟）',
  'docs.reviewFlag8Desc': '单任务超时时间（分钟）',
  'docs.reviewFlag9Desc': '输出受众：human（显示过程）或 agent（仅摘要）',
  'docs.reviewFlag10Desc': '传给所选本地 runner 的可选模型提示',
