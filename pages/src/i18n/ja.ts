...
export const ja: TranslationKeys = {
  ...
  'docs.scanFlag17Desc': 'カスタム JSON ツールRunner 認証のパス',
  'docs.scanFlag17Default': '内蔵',
  'docs.scanFlag18Desc': 'スキャンするリポジトリまたはディレクトリのルート',
  'docs.scanFlag18Default': '現在のディレクトリ',
  'docs.scanNote': '注：<code>--max-tools</code> はスキャンテンプレートのファイル単位ツール呼び出し予算を引き上げる場合にのみ効果があります —— テンプレートのデフォルトより低い値をRunner 認証しても効果はありません。',
