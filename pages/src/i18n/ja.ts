...
export const ja: TranslationKeys = {
  ...
  'quickstart.subtitle': 'OCR 側の資格情報設定は不要です。ローカルの Codex または Claude サブスクリプションログインを使用します。',
  ...
  'docs.configDesc': 'インストール済みのローカルサブスクリプション runner にログインします。OCR はエンドポイント、モデル、資格情報を保存しません。',
  ...
  'docs.configModelSelectDesc': 'OCR 実行前に claude auth login --claudeai で Claude runner を認証します。',
