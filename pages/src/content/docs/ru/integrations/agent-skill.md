...
3. **Остановка и запрос при неаутентифицированном runner.** Если preflight runner или ревью завершается ошибкой из-за отсутствующего Codex/Claude или выхода из аккаунта, агент *не* придумывает учётные данные. Он просит пользователя аутентифицировать выбранный установленный runner официальным способом входа.
