...
- **Git ≥ 2.41**
- **Node.js ≥ 18**
- **Codex CLI или Claude Code CLI, аутентифицированная поддерживаемым нативным способом**
...
Если OCR сообщает об ошибке аутентификации runner, аутентифицируйте выбранную CLI нативным входом или API-токеном и повторите команду. CI-аутентификация отделена от локального состояния: аутентифицируйте Codex или Claude внутри CI-задачи, а не храните секреты провайдера OCR.
